			...
			<nav class="container">
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarToggle">
					<ul class="navbar-nav animated remove-animation" data-animate="fadeInDown" data-delay=".75">
						...
						<li class="nav-item"><a class="nav-link menu-link" href="index#blog">المدونة</a></li>
						@auth
						<li class="nav-item">
...
<!--end section blog-->
	...
	<div class="section media-scetion pb section-pad section-bg-light">
		<div class="container">
		@yield('content')
	...
	<!-- end comment section -->
		...
		<!-- Start Section -->
		<div class="section footer-scetion footer-jasmine section-bg-alt">
			<div class="container">
